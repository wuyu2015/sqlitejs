        ...
        for (const field in fieldTypes) {
            ...
            if (typeof fieldType === 'string') {
                ...
                if (fieldType.length !== 2) {
                    throw new Error('fieldTypes array length must be 2.');
                }
                if (typeof fieldType[1] !== 'object') {
                    throw new Error('typeof fieldTypes[1] must be object.');
                }
                this.fieldTypes[field] = fieldType[0];
                this.fieldProps[field] = fieldType[1];
            } else {
